...
namespace FormUI {
    ...
    public partial class DatabaseDataSet : global::System.Data.DataSet {
        ...
        public partial class TableDataTable : global::System.Data.TypedTableBase<TableRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "15.0.0.0")]
            public TableRow AddTableRow(int Id, string FirstName, string LastName, string EmailAddress, string PhoneNumber) {
...
namespace FormUI.DatabaseDataSetTableAdapters {
    ...
    public partial class TableTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = @"DELETE FROM [dbo].[Table] WHERE (([Id] = @Original_Id) AND ((@IsNull_FirstName = 1 AND [FirstName] IS NULL) OR ([FirstName] = @Original_FirstName)) AND ((@IsNull_LastName = 1 AND [LastName] IS NULL) OR ([LastName] = @Original_LastName)) AND ((@IsNull_EmailAddress = 1 AND [EmailAddress] IS NULL) OR ([EmailAddress] = @Original_EmailAddress)) AND ((@IsNull_PhoneNumber = 1 AND [PhoneNumber] IS NULL) OR ([PhoneNumber] = @Original_PhoneNumber)))";
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[Table] ([Id], [FirstName], [LastName], [EmailAddress], [PhoneN" +
                "umber]) VALUES (@Id, @FirstName, @LastName, @EmailAddress, @PhoneNumber);\r\nSELEC" +
                "T Id, FirstName, LastName, EmailAddress, PhoneNumber FROM [Table] WHERE (Id = @I" +
                "d)";
...
SELECT Id, FirstName, LastName, EmailAddress, PhoneNumber FROM [Table] WHERE (Id = @Id)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::FormUI.Properties.Settings.Default.DatabaseConnectionString;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT Id, FirstName, LastName, EmailAddress, PhoneNumber FROM dbo.[Table]";
        ...
        public virtual int Delete(int Original_Id, string Original_FirstName, string Original_LastName, string Original_EmailAddress, string Original_PhoneNumber) {
        ...
        public virtual int Insert(int Id, string FirstName, string LastName, string EmailAddress, string PhoneNumber) {
        ...
        public virtual int Update(int Id, string FirstName, string LastName, string EmailAddress, string PhoneNumber, int Original_Id, string Original_FirstName, string Original_LastName, string Original_EmailAddress, string Original_PhoneNumber) {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string FirstName, string LastName, string EmailAddress, string PhoneNumber, int Original_Id, string Original_FirstName, string Original_LastName, string Original_EmailAddress, string Original_PhoneNumber) {
            return this.Update(Original_Id, FirstName, LastName, EmailAddress, PhoneNumber, Original_Id, Original_FirstName, Original_LastName, Original_EmailAddress, Original_PhoneNumber);
        }
    }
